  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-4
      ...
      .col-lg-7
        .cajon.color-primario.p-4.mb-4
          p.mb-0.
            La inclusión es un elemento esencial de la comunicación pública, ya que busca que todas las personas puedan acceder, comprender y utilizar la información en condiciones de igualdad. Para lograrlo, las entidades deben diseñar sus procesos comunicativos teniendo en cuenta la diversidad de la ciudadanía y las diferentes formas en que las personas interactúan con la información.
        p.mb-0.
          Incorporar la inclusión en la comunicación institucional favorece la eliminación de barreras, fortalece la participación ciudadana y contribuye a garantizar el ejercicio de los derechos. En este tema se presentan los principales aspectos relacionados con la inclusión y su aplicación en la comunicación entre las entidades públicas y la ciudadanía.
    ...
    #t_4_1.titulo-segundo.color-acento-contenido(data-aos="fade-left")
      h2.
        4.1 Concepto
    p.mb-4.
      La inclusión consiste en reconocer que las personas tienen diferentes formas de vivir, comunicarse, participar y acceder a la información. Por ello, no basta con que una persona esté presente en un proceso o servicio; también es necesario generar las condiciones para que pueda comprender la información, participar activamente y ejercer sus derechos sin enfrentar barreras.

    .tema4-concepto.mb-4
      .row.g-0.align-items-stretch
        .col-lg-7.d-flex.align-items-center.p-4
          .tema4-concepto__contenido.p-4
            p.mb-0.
    ...
    p.mb-4.
      La inclusión puede manifestarse de diferentes maneras según el contexto en el que se aplica. En la comunicación pública, reconocer estos tipos permite identificar acciones que favorecen el acceso a la información, la participación y la atención de las distintas poblaciones. A continuación, se presentan algunos de los principales tipos de inclusión y ejemplos de su aplicación:
        ...
        thead
          tr
            ...
            th.
              Descripción
            th.
              Ejemplo en la comunicación pública
        tbody
          tr
            td.
              Social.
          ...
          tr
            td.
              Cultural.
            td.
              Reconocer prácticas, lenguas, costumbres y referentes de las diferentes comunidades.
            td.
              Los mensajes se deben adaptar cuando se dirigen a comunidades étnicas o territorios específicos.
          tr
            td.
              Institucional.
            td.
              Integra criterios incluyentes en procesos, protocolos y atención ciudadana.
            td.
              Verificar formularios, respuestas, piezas comunicativas antes de ser divulgadas.
    ...
    #t_4_3.titulo-segundo.color-acento-contenido(data-aos="fade-left")
      h2.
        4.3 Principios
    p.mb-4.
      La inclusión se fundamenta en principios que orientan la construcción de una comunicación más respetuosa, accesible y pertinente. Estos principios permiten evaluar si los mensajes institucionales promueven el reconocimiento de la dignidad humana, garantizan el acceso a la información y favorecen la participación de todas las personas.
    p.mb-4.
      Los siguientes son los principios de la inclusión:

    .BG01.px-4.px-md-5.py-5.mb-4
      .tarjeta.bgwhite.p-4.p-lg-5
        SlyderA(tipo="b")
          .row.justify-content-center.align-items-center
            .col-lg-6.mb-4.mb-lg-0.order-2.order-lg-1
              h5.mb-4 Dignidad humana
              p.mb-0.
          ...
          .row.justify-content-center.align-items-center
            .col-lg-6.mb-4.mb-lg-0.order-2.order-lg-1
              h5.mb-4 Igualdad y no discriminación
              p.mb-0.
    ...
    .BG01.px-4.px-md-5.py-5.mb-5
      .tarjeta.bgwhite.p-4.p-lg-5
        PasosB.color-acento-botontes
          .row.justify-content-center.align-items-center(titulo="")
            .col-lg-6.mb-4.mb-lg-0.order-2.order-lg-1
              h5.mb-4 Ley 1346 de 2009
              p.mb-0.
    ...
    .titulo-sexto.color-acento-contenido.mb-3.mt-4
      h5.
        Tabla 5.
      span.
        Marco normativo Estado-ciudadanía
    .tabla-a.color-acento-contenido.tema1-tabla.mb-4
      table
        thead
          tr
        ...
        tbody
          ...
          tr
            td.
              CONPES 3649 de marzo de 2010.
            td.
              Política Nacional de Servicio al Ciudadano.
          tr
            td.
              CONPES 3654 de abril de 2010.
            td.
          ...
          tr
            td.
              Ley 2052 de 2020.
            td.
              Artículo 28. Dispone la incorporación del Lenguajes Claros, Comprensibles e Incluyentes en los procedimientos de las entidades públicas, según lineamientos del Gobierno Nacional.
          tr
            td.
              Circular 100-010-2021 del Departamento Administrativo de la Función Pública.
            td.
              Directrices para fomentar el uso de estructuras comunicativas comprensibles y accesibles desde las entidades hacia la ciudadanía.
      ...
      .row.justify-content-center.align-items-center
        ...
        .col-lg-2.col-md-3
          a.boton.color-acento-botones(href="https://www.youtube.com/watch?v=hnPc2hBP-mg" target="_blank" rel="noopener noreferrer")
            ...
            i.fas.fa-video
    p.mb-4.
      Para finalizar este tema y clarificar todo el proceso normativo, se relaciona una línea de tiempo de la inclusión comunicativa que ha tenido Colombia:
    ...
    LineaTiempoE.color-primario
      .row(titulo="1991" subtitulo="")
        ...
        .col-lg-8.col-md-9
          h5 Constitución Política de Colombia
          p.mb-0
            strong Fundamento: 
            | reconoce la igualdad, dignidad humana, participación ciudadana y protección de derechos fundamentales para todas las personas.
      .row(titulo="2009" subtitulo="")
        .col-lg-2.col-md-3.col-5.mb-3.mb-lg-0.d-none.d-lg-block
          img(src="@/assets/curso/temas/t4/img17.svg" alt="")
        .col-lg-8.col-md-9
          h5 Ley 1346 de 2009
          p.mb-0
            strong Convención sobre los Derechos de las Personas con Discapacidad: 
            | aprueba el tratado internacional que compromete al Estado con la inclusión y accesibilidad universal.
      .row(titulo="2011" subtitulo="")
        ...
        .col-lg-8.col-md-9
          h5 Ley 1482 de 2011
          p.mb-0
            strong Medidas contra la discriminación: 
            | establece sanciones para actos de racismo o discriminación, promoviendo un trato equitativo y respetuoso.
      .row(titulo="2013" subtitulo="")
        .col-lg-2.col-md-3.col-5.mb-3.mb-lg-0.d-none.d-lg-block
          img(src="@/assets/curso/temas/t4/img19.svg" alt="")
        .col-lg-8.col-md-9
          h5 Ley 1618 de 2013
          p.mb-0
            strong Garantía de derechos de personas con discapacidad: 
            | establece disposiciones concretas para asegurar el ejercicio pleno de derechos, incluyendo la comunicación accesible (lengua de señas, braille).
      .row(titulo="2014" subtitulo="")
        ...
        .col-lg-8.col-md-9
          h5 Ley 1712 de 2014
          p.mb-0
            strong Transparencia y acceso a la información pública: 
            | regula el derecho a conocer la información en poder del Estado de forma oportuna y comprensible.
      ...
      .row(titulo="Actualidad" subtitulo="")
        ...
        .col-lg-8.col-md-9
          h5 Lineamientos institucionales
          p.mb-0
            strong Orientaciones permanentes: 
            | guías específicas para la atención, comunicación y relacionamiento inclusivo con la ciudadanía por parte de las entidades públicas.
